...
public final class DeviceInput implements InputItem {

  private static final InputItem EMPTY_DEVICE;
  ...
  public static @NotNull InputItem ofDeviceName(@NotNull final String deviceName) {
    return new DeviceInput(deviceName);
  }

  public static @NotNull InputItem emptyDevice() {
    return EMPTY_DEVICE;
  }
