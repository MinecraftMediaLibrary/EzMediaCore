...
public class LinuxOSPackages {
  ...
  */
  ...
  private final HashMultimap<String, LinuxPackage> links;
   ...
   * @param links URLs
   */
  LinuxOSPackages(@NotNull final HashMultimap<String, LinuxPackage> links) {
    this.links = links;
  }
   ...
   */
  public HashMultimap<String, LinuxPackage> getLinks() {
    return links;
  }
}
